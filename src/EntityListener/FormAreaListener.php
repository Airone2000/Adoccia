...
final class FormAreaListener
{
    ...
    public function prePersist(FormArea $formArea): void
    {
        /*
         * If position is NULL, then fetch lastPositionedArea from database and add +1
         */
        if (null === $formArea->getPosition() && $formArea->getForm() instanceof Form) {
    ...
    public function postRemove(FormArea $formArea): void
    {
        /**
