...
final class FormController extends AbstractController
{
     ...
     * {@inheritdoc}
     */
    public function editDraftForm(Form $form, CategoryRepository $categoryRepository): Response
    {
     ...
     * {@inheritdoc}
     */
    public function addFormAreaToDraftForm(Form $form, FormHandlerInterface $formHandler): Response
    {
     ...
     * {@inheritdoc}
     */
    public function sortDraftFormAreas(Form $form, Request $request, FormHandlerInterface $formHandler): Response
    {
        try {
     ...
     * {@inheritdoc}
     */
    public function publishDraftForm(Form $form, CategoryRepository $categoryRepository, FormHandlerInterface $formHandler): Response
    {
        try {
            $category = $categoryRepository->findOneBy(['draftForm' => $form]);
            if (null === $category) {
                throw new \Exception('Not a draft form or deleted category.');
            }
     ...
     * {@inheritdoc}
     */
    public function deleteDraftForm(Form $form): Response
    {
     ...
     * {@inheritdoc}
     */
    public function preview(Form $form, CategoryRepository $categoryRepository): Response
    {
        $fiche = new Fiche();
