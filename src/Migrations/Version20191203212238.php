...
final class Version20191203212238 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category_search (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, guest_unique_id VARCHAR(80) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, order_by VARCHAR(50) DEFAULT NULL, filter VARCHAR(50) DEFAULT NULL, page INT DEFAULT 1 NOT NULL, items_per_page INT DEFAULT 30 NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_BB1811DCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
