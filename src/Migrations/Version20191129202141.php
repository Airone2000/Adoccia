 ...
 */
final class Version20191129202141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category_search (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, guest_unique_id VARCHAR(80) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, order_by VARCHAR(50) DEFAULT NULL, filter VARCHAR(50) DEFAULT NULL, page INT DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_BB1811DCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fiche (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, creator_id INT DEFAULT NULL, picture_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, published TINYINT(1) DEFAULT \'0\' NOT NULL, valid TINYINT(1) DEFAULT \'1\' NOT NULL, INDEX IDX_4C13CC7812469DE2 (category_id), INDEX IDX_4C13CC7861220EA6 (creator_id), UNIQUE INDEX UNIQ_4C13CC78EE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, description VARCHAR(500) DEFAULT NULL, source VARCHAR(255) DEFAULT NULL, filename VARCHAR(100) NOT NULL, width INT DEFAULT 0 NOT NULL, height INT DEFAULT 0 NOT NULL, is_temp TINYINT(1) DEFAULT \'1\' NOT NULL, unique_id VARCHAR(64) NOT NULL, INDEX IDX_16DB4F89A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
