 ...
 */
final class Version20191017153434 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE form_area (id INT AUTO_INCREMENT NOT NULL, form_id INT NOT NULL, width DOUBLE PRECISION DEFAULT \'100\' NOT NULL, INDEX IDX_43B5397F5FF69B7D (form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
