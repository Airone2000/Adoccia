 ...
 */
final class Version20191107162416 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE value ADD CONSTRAINT FK_1D775834793D36A4 FOREIGN KEY (value_of_type_fichecreator_id) REFERENCES user (id) ON DELETE SET NULL');
