 ...
 */
final class Version20191023200347 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, picture_id INT DEFAULT NULL, form_id INT DEFAULT NULL, draft_form_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, published TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_64C19C1B03A8386 (created_by_id), UNIQUE INDEX UNIQ_64C19C1EE45BDBF (picture_id), UNIQUE INDEX UNIQ_64C19C15FF69B7D (form_id), UNIQUE INDEX UNIQ_64C19C1A73FE35E (draft_form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE value (id INT AUTO_INCREMENT NOT NULL, fiche_id INT NOT NULL, widget_id INT NOT NULL, value_of_type_text LONGTEXT DEFAULT NULL, value_of_type_string LONGTEXT DEFAULT NULL, INDEX IDX_1D775834DF522508 (fiche_id), INDEX IDX_1D775834FBE885E2 (widget_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fiche (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_4C13CC7812469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE widget (id INT AUTO_INCREMENT NOT NULL, form_area_id INT NOT NULL, type VARCHAR(30) NOT NULL, inner_text LONGTEXT DEFAULT NULL, min_length BIGINT DEFAULT NULL, max_length BIGINT DEFAULT NULL, required TINYINT(1) DEFAULT \'0\' NOT NULL, text_align VARCHAR(20) DEFAULT NULL, UNIQUE INDEX UNIQ_85F91ED08C6320A7 (form_area_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
