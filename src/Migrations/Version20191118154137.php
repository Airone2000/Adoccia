 ...
 */
final class Version20191118154137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE value (id INT AUTO_INCREMENT NOT NULL, fiche_id INT NOT NULL, widget_id INT NOT NULL, widget_immutable_id VARCHAR(50) NOT NULL, value_of_type_text LONGTEXT DEFAULT NULL, value_of_type_string LONGTEXT DEFAULT NULL, value_of_type_int VARCHAR(100) DEFAULT NULL, value_of_type_float VARCHAR(100) DEFAULT NULL, value_of_type_date DATE DEFAULT NULL, value_of_type_time TIME DEFAULT NULL, value_of_type_radio LONGTEXT DEFAULT NULL, value_of_type_email VARCHAR(255) DEFAULT NULL, value_of_type_map JSON DEFAULT NULL, value_of_type_button JSON DEFAULT NULL, INDEX IDX_1D775834DF522508 (fiche_id), INDEX IDX_1D775834FBE885E2 (widget_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
