 ...
 */
final class Version20191022115437 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE widget (id INT AUTO_INCREMENT NOT NULL, form_area_id INT NOT NULL, type VARCHAR(30) NOT NULL, inner_text LONGTEXT DEFAULT NULL, min_length BIGINT DEFAULT NULL, max_length BIGINT DEFAULT NULL, required TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_85F91ED08C6320A7 (form_area_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
